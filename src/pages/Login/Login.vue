<template> 
	<section class="loginContainer">
      ...
      <AlertTip :alertText="alertText" v-show="isShowAlert"
...
<script>
  ...
  export default {
    ...
    methods: {
      //异步获取短信验证码
      async getCode(){
          //注意这里会有一个默认的事件发生,就是点击button后,页面的
        //url会变为: http://localhost:8080/?#/login多了一个问号
        //解决方式: @click.prevent="getCode"
